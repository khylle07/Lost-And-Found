...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO items (user_id, category_id, title, description, item_type, location, date_lost_found, color, brand, contact_info) VALUES (?, ?, ?, ?, 'lost', ?, ?, ?, ?, ?)");
    $stmt->bind_param("iisssssss", $user_id, $category_id, $title, $description, $location, $date_lost, $color, $brand, $contact_info);
    
    if ($stmt->execute()) {
        echo json_encode(['status' => 'success', 'message' => 'Lost item reported successfully! It will be reviewed by admin.']);
    } else {
        echo json_encode(['status' => 'error', 'message' => 'Error reporting lost item: ' . $stmt->error]);
    }
    $stmt->close();
    exit();
}
...
<head>
    ...
    <title>Report Lost Item | NCST Lost & Found</title>
...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10 col-xl-8">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Report Lost Item</h2>
                    ...
                    <div class="card report-card">
                        <div class="card-header bg-light">
                            <h5 class="card-title mb-0"><i class="bi bi-info-circle me-2"></i>Item Information</h5>
                        </div>
                        <div class="card-body p-4">
                            <form id="reportForm">
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="title" 
                                                   ...
                                                   maxlength="100">
                                            <div class="form-text">Brief description of the lost item</div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="description" rows="4" 
                                                  placeholder="Provide detailed description of the item, including any distinctive features, contents, etc."
                                                  required></textarea>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label fw-semibold">Where did you lose it? *</label>
                                            <input type="text" class="form-control" name="location" 
                                                   placeholder="e.g., NCST Library, Cafeteria, Building A, etc."
                                                   required>
                                            <div class="form-text">Specific location where you last had the item</div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label fw-semibold">When did you lose it? *</label>
                                            <input type="date" class="form-control" name="date_lost" 
                                                   max="<?php echo date('Y-m-d'); ?>" required>
                                            <div class="form-text">Approximate date when you lost the item</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Additional Contact Info</label>
                                        ...
                                        <div class="form-text">How should people contact you if they find your item? (Your registered contact number will be used if left blank)</div>
                                    </div>
                                </div>
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <ul class="mb-0">
                                        ...
                                        <li>Provide accurate information to increase chances of recovery</li>
                                        <li>You will be notified if someone finds your item</li>
                                        <li>Keep your contact information updated in your account settings</li>
                                    </ul>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('input[name="date_lost"]').attr('max', new Date().toISOString().split('T')[0]);
        });
    </script>
</body>
</html>
